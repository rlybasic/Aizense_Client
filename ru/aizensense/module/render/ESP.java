...
extends Module {
    ...
    public ESP() {
        ...
        Modes.add("2D");
        Modes.add("Glowing");
        AizenSense.instance.settingsManager.rSetting(new Setting("Mode", this, "Glowing", (ArrayList)Modes));
        AizenSense.instance.settingsManager.rSetting(new Setting("Hunger", this, false));
        AizenSense.instance.settingsManager.rSetting(new Setting("Health", this, true));
        AizenSense.instance.settingsManager.rSetting(new Setting("healthValue", this, true));
        AizenSense.instance.settingsManager.rSetting(new Setting("Box", this, true));
        AizenSense.instance.settingsManager.rSetting(new Setting("Tag", this, true));
        AizenSense.instance.settingsManager.rSetting(new Setting("Show current item", this, false));
        AizenSense.instance.settingsManager.rSetting(new Setting("Local", this, false));
        AizenSense.instance.settingsManager.rSetting(new Setting("3DAlpha", this, 0.7, 0.0, 1.0, false));
    }
    ...
    public void onRenderWorld(RenderWorldLastEvent event) {
        ...
        boolean Hunger = AizenSense.instance.settingsManager.getSettingByName(this, "Hunger").getValBoolean();
        boolean Health = AizenSense.instance.settingsManager.getSettingByName(this, "Health").getValBoolean();
        boolean healthValue = AizenSense.instance.settingsManager.getSettingByName(this, "healthValue").getValBoolean();
        boolean Box = AizenSense.instance.settingsManager.getSettingByName(this, "Box").getValBoolean();
        boolean Tag = AizenSense.instance.settingsManager.getSettingByName(this, "Tag").getValBoolean();
        boolean currentItem = AizenSense.instance.settingsManager.getSettingByName(this, "Show current item").getValBoolean();
        boolean Local = AizenSense.instance.settingsManager.getSettingByName(this, "Local").getValBoolean();
        float Alpha = (float)AizenSense.instance.settingsManager.getSettingByName(this, "3DAlpha").getValDouble();
        if (Mode == "2D") {
            for (Entity e : ESP.mc.world.loadedEntityList) {
                ...
                if (Box) {
                    if (FriendManager.friendsList.contains(e.getName())) {
